...
const HomeSectionCard = ({ product }) => {
  return (
    <div className='productCard cursor-pointer flex flex-col items-center bg-white rounded-lg shadow-xl w-[15rem] h-[20rem] overflow-hidden mx-3 border border-blue-300'>
